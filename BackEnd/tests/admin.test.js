...
describe("Admin API", () => {
  ...
  beforeEach(async () => {
    ...
    await request(app).post("/api/v1/auth/register").send({
      name: "Admin", phone: "0911000000", pin: "1234", role: "admin", location: { region: "A", zone: "B", kebele: "C" }
    });
    const loginAdmin = await request(app).post("/api/v1/auth/login").send({ phone: "0911000000", pin: "1234" });
