...
const FloatingActionButton = ({
  ...
  return <Animated.View style={[styles.fabWrapper, {
    bottom,
    right,
    transform: [{
      scale: scaleAnim
      ...
      <Pressable onPress={onPress} onPressIn={handlePressIn} onPressOut={handlePressOut} style={({
      pressed
    }) => [styles.fab, {
      ...
      shadowRadius: 8,
      elevation: 8
    }]} accessibilityRole="button" accessibilityLabel={icon === "add" ? "Add new product" : "Action"}>
