          ...
          >
            <View style={[styles.modal, { backgroundColor: surfaceColor }]}>
              ...
              <View style={styles.header}>
                <AppText variant="headingSm" style={{ color: textPrimary, fontWeight: "700" }}>
                  List New Produce
                </AppText>
                <TouchableOpacity
                  onPress={onClose}
              ...
              {/* Crop Name */}
              <AppText variant="caption" style={[styles.label, { color: textSecondary }]}>
                Crop Name
              </AppText>
              <TextInput
                style={[
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      styles.optionChip,
                      {
                        borderColor,
                        backgroundColor:
                          newProduct.category === cat ? primaryColor : "transparent",
                      },
                    ]}
                    activeOpacity={0.7}
                  >
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      styles.optionChip,
                      {
                        borderColor,
                        backgroundColor:
                          newProduct.unit === unit ? primaryColor : "transparent",
                      },
                    ]}
                    activeOpacity={0.7}
                  >
              ...
              {error ? (
                <View style={styles.errorContainer}>
                  ...
                  <AppText variant="caption" style={{ color: errorColor, marginLeft: 4 }}>
                    {error}
                  </AppText>
                </View>
              ) : null}
