...
export default function OnboardingTrack({ navigation }) {
    ...
    <ScreenWrapper padding={false}>
      ...
      >
        ...
        <View style={styles.illustrationContainer}>
          ...
          >
            <Image
              //   source={require("../../assets/images/onboard_track.png")}
              source={{
                uri: "https://images.unsplash.com/vector-1739803880008-09056660fbc7?q=80&w=580&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
              }}
              style={styles.image}
              resizeMode="contain"
            />
        ...
        <View style={styles.content}>
          ...
          >
            Manage logistics and deliveries with real-time tracking.
          </AppText>
